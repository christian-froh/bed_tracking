defmodule BedTrackingGraphql.Schema.Hospital do
  ...
  object :hospital do
    ...
    field :total_rrt_type_none, :integer do
      resolve(&Resolver.Hospital.dataloader_total_rrt_type_none/3)
    end

    field :total_rrt_type_risk_of_next_twenty_four_h, :integer do
      resolve(&Resolver.Hospital.dataloader_total_rrt_type_risk_of_next_twenty_four_h/3)
    end

    field :total_rrt_type_haemodialysis, :integer do
      resolve(&Resolver.Hospital.dataloader_total_rrt_type_haemodialysis/3)
    end

    field :total_rrt_type_haemofiltration, :integer do
      resolve(&Resolver.Hospital.dataloader_total_rrt_type_haemofiltration/3)
    end

    field :total_rrt_type_pd, :integer do
      resolve(&Resolver.Hospital.dataloader_total_rrt_type_pd/3)
    end
